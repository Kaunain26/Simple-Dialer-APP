...
// Palette used for contact/message placeholders without images – inspired by contemporary chat apps
val letterBackgroundColors = arrayListOf(
    0xFFE8F1FF, // airy blue
    0xFFF0EBFF, // lilac mist
    0xFFEFE6FF, // soft lavender
    0xFFE5F7FF, // powder azure
    0xFFE8FFF7, // mint haze
    0xFFEFFFEF, // light sage
    0xFFFFF3DC, // mellow amber
    0xFFFFE6D8, // peach blush
    0xFFFFE1DA, // coral cloud
    0xFFFBE5F2, // petal pink
    0xFFF1ECFF, // violet veil
    0xFFEAF9F4  // seafoam veil
)
