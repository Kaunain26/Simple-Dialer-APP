    ...
    init {
        actModeCallback = object : MyActionModeCallback() {
            ...
            override fun onCreateActionMode(actionMode: ActionMode, menu: Menu?): Boolean {
                ...
                actBarTextView!!.setTextColor(textColor)
                activity.updateMenuItemColors(menu, baseColor = bgColor)
                activity.findViewById<View>(androidx.appcompat.R.id.action_mode_bar)?.setBackgroundColor(bgColor)
                onActionModeCreated()
                actBarTextView?.onGlobalLayout {
                    ...
                    backArrow?.applyColorFilter(textColor)
                }
                return true
            }
